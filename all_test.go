...
func TestSPSCrs_one(t *testing.T) {
	...
	for _, size := range TestSizes {
		name := "b" + strconv.Itoa(batchSize) + "s" + strconv.Itoa(size)
		t.Run(name, func(t *testing.T) { RunTests(t, func() Queue { return NewSPSCrs_one(size) }) })
	}
}
...
func BenchmarkSPSCrs_one(b *testing.B) {
	...
	for _, size := range BenchSizes {
		name := strconv.Itoa(batchSize) + "s" + strconv.Itoa(size)
		b.Run(name, func(b *testing.B) { RunBenchmarks(b, func() Queue { return NewSPSCrs_one(size) }) })
	}
}
...
func TestSPMCrs_one(t *testing.T) {
	...
	for _, size := range TestSizes {
		name := "b" + strconv.Itoa(batchSize) + "s" + strconv.Itoa(size)
		t.Run(name, func(t *testing.T) { RunTests(t, func() Queue { return NewSPMCrs_one(size) }) })
	}
}
...
func BenchmarkSPMCrs_one(b *testing.B) {
	...
	for _, size := range BenchSizes {
		name := strconv.Itoa(batchSize) + "s" + strconv.Itoa(size)
		b.Run(name, func(b *testing.B) { RunBenchmarks(b, func() Queue { return NewSPMCrs_one(size) }) })
	}
}
...
func TestMPSCrs_one(t *testing.T) {
	...
	for _, size := range TestSizes {
		name := "b" + strconv.Itoa(batchSize) + "s" + strconv.Itoa(size)
		t.Run(name, func(t *testing.T) { RunTests(t, func() Queue { return NewMPSCrs_one(size) }) })
	}
}
...
func BenchmarkMPSCrs_one(b *testing.B) {
	...
	for _, size := range BenchSizes {
		name := strconv.Itoa(batchSize) + "s" + strconv.Itoa(size)
		b.Run(name, func(b *testing.B) { RunBenchmarks(b, func() Queue { return NewMPSCrs_one(size) }) })
	}
}
...
func TestMPSCnw_fl(t *testing.T) {
	...
	size := 0
	name := "b" + strconv.Itoa(batchSize) + "s" + strconv.Itoa(size)
	t.Run(name, func(t *testing.T) { RunTests(t, func() Queue { return NewMPSCnw_fl() }) })
}
...
func BenchmarkMPSCnw_fl(b *testing.B) {
	...
	size := 0
	name := strconv.Itoa(batchSize) + "s" + strconv.Itoa(size)
	b.Run(name, func(b *testing.B) { RunBenchmarks(b, func() Queue { return NewMPSCnw_fl() }) })
}
